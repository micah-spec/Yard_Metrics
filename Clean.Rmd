...
# Create new column with quantity of additional moves needed to hit 5 moves/hr target that must be On Time 
       v8 <- v7 %>% mutate(On_Time_Target = pmax(round(.78*(Moves+Target_Moves)-On_Time,digits=0),0))
