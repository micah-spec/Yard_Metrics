---
title: "Short Shift Analysis from 2023-02-05 to 2023-02-12"
output: 
...
```{r}
target("2023-02-05","2023-02-12",a1)
```

### Short Shift = 1
```{r}
short_shift("2023-02-05","2023-02-12",a1,1)
```

### Short Shift = 2
```{r}
short_shift("2023-02-05","2023-02-12",a1,2)
```
...
```{r}
target("2023-02-05","2023-02-12",b1)
```

### Short Shift = 1
```{r}
short_shift("2023-02-05","2023-02-12",b1,1)
```

### Short Shift = 2
```{r}
short_shift("2023-02-05","2023-02-12",b1,2)
```
